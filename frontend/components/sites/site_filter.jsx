                                ...
                                ? (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            Campfire</button>
                                        <button
                                            className={this.state.pet_allow ? 'active_filter_button' : ''}
                                            name='pets_allow'
                                ...
                                ? (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            Hiking</button>
                                        <button
                                            className={this.state.rafting ? 'active_filter_button' : ''}
                                            name="paddling"
                                            onClick={this.toggle('rafting')}>
...
export default withRouter(SiteFilter);